...
fn generate_continuousely(in_file: String) {
    ...
    let encoder_thread = thread::spawn(move || {
        loop {
            ...
            println!("Time: {}:{}, Cycle: {}, Frame: {} - Size of MsgQueue: {}",
                     dt.minute(), dt.second(), cycle_nr, frame_nr, msg_vec.len());
            ...
            socket.send_to(&frames_hton(&vec![frame]), "127.0.0.1:51337").expect("couldn't send data");
